...
export default class DeadlyNadder extends DefaultDragon {
    static readonly EntityTypes = ["gm1_zen:deadlynadder"];
    ...
    FavoriteFood = ["minecraft:chicken", "minecraft:cooked_chicken"];
